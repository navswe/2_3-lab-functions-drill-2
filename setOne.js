...
const printParameters = (parameter1, parameter2) =>
  console.log(
    `The first parameter is ${parameter1}. The second parameter is ${parameter2}.`
  );

//test case:
printParameters("param1", "param2");
...
const greeting = function (firstName, lastName, callbackFunction) {
...
// TODO: check the syntax for call backs

const pricesPlusTax = function (prices, callbackFunction) {
  // define totalCost array
  for (item in prices) {
    totalCost.push(prices[item] * 1.2);
  }
  callbackFunction(totalCost);
};

const printTotalCost = (totalCost) =>
...
// TODO: check syntax of callback functions
